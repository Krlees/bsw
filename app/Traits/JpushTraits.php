...
trait JpushTraits
{
    ...
    public $app_key = '9176a05e4e1acf93352161bf';        //待发送的应用程序(appKey)，只能填一个。
    public $master_secret = '7e8399c399cdd3838b368259';    //主密码
    public $url = "https://api.jpush.cn/v3/push";      //推送的地址
    ...
    */
     ...
     * @return bool|mixed
     */
    public function push($receiver = 'all', $content = '', $m_type = '', $m_txt = '', $m_time = '86400', $pushId = 1)
    {
        ...
        $data['notification'] = array(
            ...
            "android" => array(
                ...
                "extras" => array("pushId" => $pushId, "type" => $m_type, "txt" => $m_txt)
            ),
            //ios的自定义
            "ios" => array(
                // "alert"=>$content,
                "badge" => "+1",
                "sound" => "customNotification.caf",
                // "extras"=>array("type"=>$m_type, "txt"=>$m_txt)
                "extras" => array("pushId" => $pushId, "type" => $m_type, "txt" => $m_txt)
            ),
        );
    ...
    public function push_test($receiver = 'all', $content = '', $m_type = '', $m_txt = '', $m_time = '86400', $pushId = 1)
    {
        $base64 = base64_encode("$this->app_key:$this->master_secret");
        $header = array("Authorization:Basic $base64", "Content-Type:application/json");
        $data = array();
...
//          ),
    ...
    */
    ...
    public function push_message($receiver = 'all', $content = '', $m_type = '', $m_txt = '', $m_time = '86400', $pushId = 1)
    {
        $base64 = base64_encode("$this->app_key:$this->master_secret");
        $header = array("Authorization:Basic $base64", "Content-Type:application/json");
        $data = array();
